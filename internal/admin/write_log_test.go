...
func TestClassifyRequest(t *testing.T) {
	tests := []struct {
		...
		{"PATCH", "/api/channels/ch1", "patch_channel", "channel", "ch1"},
		{"POST", "/api/channels/ch1/clone", "clone_channel", "channel", "ch1"},
		{"PUT", "/api/channels/ch1/policy", "update_channel_policy", "channel", "ch1"},
		{"PUT", "/api/channels/ch1/on-demand-profile", "update_on_demand_profile", "channel", "ch1"},
		...
		{"PUT", "/api/package-profiles/h264-1080p-8mbps", "update_package_profile", "profile", "h264-1080p-8mbps"},
		{"POST", "/api/package-profiles/h264-1080p-8mbps/enable", "enable_package_profile", "profile", "h264-1080p-8mbps"},
		{"DELETE", "/api/package-profiles/h264-1080p-8mbps", "delete_package_profile", "profile", "h264-1080p-8mbps"},
		...
		{"POST", "/api/media/collections/bulk", "bulk_update_media_collection", "media", "collection"},
		{"POST", "/api/channels", "create_channel", "channel", ""},
...
func TestShouldSkipWriteLog(t *testing.T) {
	...
	keep := []string{
		...
		"/api/channels/ch1/on-demand-profile",
		"/api/channels/ch1",
		"/api/admin/local-sources",
		"/api/admin/local-sources/src1",
		"/api/package-profiles/h264-1080p-8mbps",
		"/api/package-profiles/h264-1080p-8mbps/enable",
