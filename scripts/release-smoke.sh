...
usage() {
  cat <<'EOF'
Usage: scripts/release-smoke.sh <host> [--timeout <seconds>]
       scripts/release-smoke.sh --host <host> [--web-base-url <url>] [--playback-base-url <url>] [--admin-api-url <url>] [--timeout <seconds>]
